...
public class HiloPartesIdAsignar extends AsyncTask<Void,Void,Void>{
    ...
    public HiloPartesIdAsignar(Context context, int idUser, int idParte, String ipCliente, String apiKey) {
        this.idUser=idUser;
